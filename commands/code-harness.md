...
`.gitignore`에 `code-harness/harness-state/`, `code-harness/reports/`, `code-harness/PLAN.md`, `code-harness/TASKS.md`, `code-harness/QA.md`가 없으면 추가한다 (initializing 재진입 시 누락 방지).
