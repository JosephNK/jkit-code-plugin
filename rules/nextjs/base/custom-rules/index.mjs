...
import noNestedFeatureDir from "./no-nested-feature-dir.mjs";
import noUnknownSrcDir from "./no-unknown-src-dir.mjs";
...
export default {
  rules: {
    ...
    "no-nested-feature-dir": noNestedFeatureDir,
    "no-unknown-src-dir": noUnknownSrcDir,
