...
- [Lint]({{DOCS_DIR}}LINT.md) — **MUST read when writing or modifying code.** Layer glossary, rule table, allow matrix, boundary elements & path layout, stylelint (CSS) rules.
