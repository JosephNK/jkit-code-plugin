...
function printUsage() {
  process.stderr.write(
    "Usage: flutter-di-template.mjs <ScreenName> [feature_dir] [--package <pkg>]\n",
  );
  process.stderr.write(
    "Example: flutter-di-template.mjs Login login --package vocabit_app\n",
  );
  process.stderr.write(
    "Example: flutter-di-template.mjs Settings user/settings --package vocabit_app\n",
  );
}
